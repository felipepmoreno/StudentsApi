...
namespace AlunosApi.Services
{
    public class AlunosService : IAlunoService
    {
        ...
        {
            _context = context;
            //esse construtor pode ser gerado porque definimos o contexto no ConfigureServices no Startup.cs 
        }
        ...
        public async Task<IEnumerable<Aluno>> GetAlunosByNome(string nome)
        {
            ...
            return alunos;//retorna alunos por nome ou sem filtro se nao corresponder ao if
        }
